...
export default function DataTable({
  ...
  return (
    <div className={`rounded-lg border m-4 ${isDark ? 'bg-DarkBG1 border-DarkBG3' : 'bg-LightBG1 border-LightBG2 '} `}>
      <div className="p-4">
        ...
        <div className="">
          <table className={`min-w-full  divide-y ${isDark ? 'divide-DarkBG1 ' : 'divide-LightBG3'}`}>
            ...
            />
            <tbody className={`divide-y ${isDark ? 'divide-DarkBG1 ' : 'divide-LightBG3'}`}>
